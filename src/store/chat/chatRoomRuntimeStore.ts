...
import { ChatMessageUI, Message, WebSocketReceiveTagProps } from '@/shared/types/websocket';
...
type ChatRoomRuntimeTypes = ChatRoomRuntimeState & Ephemeral;
