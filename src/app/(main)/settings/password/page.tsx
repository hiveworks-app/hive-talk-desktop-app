        ...
        <div className="mx-auto max-w-[400px]">
          ...
          <div className="mb-6">
            <div className="mb-2 flex items-center justify-between">
              ...
              <span className="text-xs text-text-tertiary">{stepNum} / 3</span>
            </div>
          ...
          {step === 'EMAIL' && (
            <div className="space-y-4">
              ...
              <div className="rounded-lg border border-divider bg-surface px-4 py-3">
                <span className="text-xs text-text-tertiary">등록 이메일</span>
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full rounded-lg bg-primary py-2.5 text-sm font-semibold text-on-primary disabled:bg-disabled"
              >
          ...
          {step === 'CODE' && (
            <div className="space-y-4">
              ...
              <input
                ...
                placeholder="000000"
                maxLength={6}
                className="w-full rounded-lg border border-divider bg-surface px-4 py-3 text-center text-xl tracking-[0.5em] text-text-primary outline-none focus:border-primary"
              />
              <button
              ...
              <button
                onClick={handleSendCode}
                disabled={isLoading}
                className="w-full text-xs text-text-tertiary hover:underline"
              >
                인증 코드 재발송
              </button>
            </div>
          ...
          {step === 'PASSWORD' && (
            <div className="space-y-4">
              ...
              <div>
                <label className="mb-1 block text-xs font-medium text-text-secondary">새 비밀번호</label>
                <input
                  type="password"
                  value={password}
                  onChange={e => setPassword(e.target.value)}
                  className="w-full rounded-lg border border-divider bg-surface px-3 py-2.5 text-sm text-text-primary outline-none focus:border-primary"
                />
              </div>
              <div>
                <label className="mb-1 block text-xs font-medium text-text-secondary">비밀번호 확인</label>
                <input
                  type="password"
